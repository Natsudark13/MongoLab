 ...
 * @author Extreme PC
 */
public class UpdateP2 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Ingrese el ID de la productora a actualizar");
   ...
   con.updateProductora(ID.getText(), nombre.getText(), fecha.getText(), url.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateP2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
